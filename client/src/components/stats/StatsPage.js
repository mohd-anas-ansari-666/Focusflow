    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="loading-spinner w-8 h-8 border-4 border-blue-600 border-t-transparent rounded-full" />
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">View your productivity analytics and insights</p>
        </div>
          ...
          {categoryData.length > 0 ? (
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                ...
                <Tooltip formatter={(value) => [`${Math.round(value / 60 * 10) / 10} hours`, 'Time']} />
              </PieChart>
            </ResponsiveContainer>
          ) : (
            <div className="h-64 flex items-center justify-center text-gray-500">
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              ...
              <span className="font-semibold text-gray-900">{habitStats.totalHabits}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
              <span className="text-gray-700">Completed Today</span>
              <span className="font-semibold text-green-900">{habitStats.completedToday}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
              <span className="text-gray-700">Active Streaks</span>
          ...
          {habits.length > 0 ? (
            <div className="space-y-3">
              {habits
                ...
                .slice(0, 5)
                .map((habit) => (
                  <div key={habit._id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <div>
